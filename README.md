...
Options:
  ...
  --runtime NAME                Lambda runtime to use (type: string, default: nodejs10.x, known values:
                                nodejs14.x, nodejs12.x, nodejs10.x, python3.9, python3.8, python3.7, python3.6,
                                python2.7, ruby2.7, ruby2.5, java11, java8.al2, java8, go1.x, dotnetcore3.1,
                                dotnetcore2.1, provided.al2, provided, note: required when creating a new
                                function)
